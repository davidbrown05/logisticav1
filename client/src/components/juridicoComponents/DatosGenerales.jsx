...
export const DatosGenerales = ({ id }) => {
  ...
  const permissionsMapping = {
    actualizarDatos: "ACTUALIZAR DATOS GENERALES",
  ...
  const can_ActualizarDatos = userCOntext.permisos.some(
          ...
          <div className="grid grid-cols-2 items-center justify-between gap-5  lg:grid-cols-3 lg:gap-4  p-6 w-full lg:w-[1000px] md:w-[800px]">
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <option value="ESPECIAL HIPOTECARIO">
            ...
            <div>
              <button
                className={`bg-black text-white px-4 py-2 rounded ${
                  can_ActualizarDatos ? "" : "opacity-50 cursor-not-allowed"
                }`}
                disabled={!can_ActualizarDatos}
              >
                ACTUALIZAR
              </button>
            </div>
