const Product = require('../models/ventasModel')
...
const getProducts = asyncHandler(async(req,res) =>{
    try {
        const products = await Product.find({}).populate("compradorRef");
...
const getProduct = asyncHandler(async(req, res) =>{
    try {
        const {id} = req.params
        const product = await Product.find({ propertyId: id }).populate("compradorRef");
